...
# XOR dataset with 10 variables
X = np.random.randint(0, 2, (1024, 10))  # 1024 samples of 10 binary input variables
y = np.array([[np.bitwise_xor.reduce(row)] for row in X])
